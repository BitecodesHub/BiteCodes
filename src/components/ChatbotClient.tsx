...
import { Send, MessageCircle, X, Minimize2, Maximize2, Bot, User, Sparkles, Trash2 } from 'lucide-react';
...
const ChatbotClient: React.FC<ChatbotClientProps> = ({ apiKey }) => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className={`fixed bottom-6 right-6 w-11/12 max-w-md sm:max-w-lg md:max-w-xl lg:w-96 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 z-50 transition-all duration-300 ${
