        ...
        <div className="border-t border-neutral/10 pt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/bitecodes" target="_blank" rel="noopener noreferrer" className="text-neutral/80 hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="https://www.instagram.com/bitecodes.co" target="_blank" rel="noopener noreferrer" className="text-neutral/80 hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
