...
export default function AppDevelopmentPage() {
  ...
  const headline = "Premium App Development";
  const headlineLetters = headline.split("");

  // Pricing and service data
  const services = [
    { title: "Native App Development", desc: "High-performance iOS and Android apps tailored to your needs." },
    { title: "Cross-Platform Solutions", desc: "Cost-effective apps using React Native or Flutter." },
    { title: "App Store Optimization", desc: "Boost your app’s visibility with expert ASO strategies." },
    { title: "Maintenance Plans", desc: "Ongoing support and updates for your mobile apps." },
  ];

  const pricingData = {
    Development: [
      { title: "Basic App", price: "₹10,000 - ₹20,000", features: ["Basic UI", "Single Platform", "Core Features"] },
      { title: "Premium App", price: "₹20,000 - ₹30,000", features: ["Advanced UI", "Dual Platform", "API Integration"] },
      { title: "Enterprise App", price: "₹30,000 - ₹50,000", features: ["Custom Features", "Scalable Backend", "Analytics"] },
    ],
    Services: [
      { title: "App Store Setup", price: "₹5,000 - ₹15,000", features: ["App Submission", "Optimization", "Compliance"] },
      { title: "Backend Development", price: "₹20,000 - ₹50,000", features: ["API Development", "Database", "Server Setup"] },
      { title: "App Redesign", price: "50% Off", features: ["UI/UX Overhaul", "Performance Tuning", "Feature Upgrade"] },
      { title: "ASO Package", price: "₹10,000 - ₹20,000", features: ["Keyword Research", "Metadata Optimization", "Reports"] },
    ],
    Maintenance: [
      { title: "App Maintenance", price: "₹5,000 - ₹20,000", features: ["Bug Fixes", "Updates", "24/7 Support"] },
    ],
  };

  const testimonials = [
    { name: "Amit Sharma", text: "Our app’s performance improved drastically after their optimization!", rating: 5 },
    { name: "Priya Patel", text: "The UI design is sleek and user-friendly. Highly recommend!", rating: 5 },
    { name: "Rakesh Mehta", text: "Professional team with affordable pricing.", rating: 4 },
  ];
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            >
              Crafting seamless mobile experiences with cutting-edge technology for iOS and Android.
            </motion.p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative overflow-hidden">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-yellow-300 mb-6">
              Get a Stunning Mobile App for Only <span className="text-4xl font-bold">₹1,999</span>!
            </p>
